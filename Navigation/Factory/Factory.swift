...
final class Factory {
    ...
    func startModule(coordinator: CoordinatorViewController, data: (userService: UserServiceProtocol, userLogin: String)?) -> UINavigationController? {
        ...
        case .audio:
            ...
            audioNC.tabBarItem = UITabBarItem(title: "Music", image: UIImage(systemName: "music.note.tv"), selectedImage: UIImage(systemName: "music.note"))
            return audioNC
        ...
        case .video:
            ...
            videoNC.tabBarItem = UITabBarItem(title: "Video", image: UIImage(systemName: "tv"), selectedImage: UIImage(systemName: "play.tv"))
            return videoNC
        }
    }
}
